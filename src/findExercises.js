...
export const getInstructorById = id => {
    const instructorArray = instructors.find(instructor => {
...
export const getStudentByLastName = studentLastName => {
    const lastNameArray = students.find(student => {
        const studentLast = student.lastName
        return studentLast.toLowerCase() === studentLastName.toLowerCase()
    })
...
export const getStudentByName = fullName => {
    const fullNameArray = students.find(student => {
...
export const getInstructorOfStudent = studentId => {
    const instructorArray = students.find(instructor => {
